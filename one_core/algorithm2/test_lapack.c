...
double* linear_system_solver(int N, double* b, double** A) {
  /*
    ...
    int N --> int dimension of the squared matrix A and vector b
    double* b --> vector of size N
    double** A --> squared matrix (N x N), cannot be singular
...
int main() {
  ...
  double** B = d_malloc_2d(5,5);
  double* b = (double *)malloc(5*sizeof(double)) ;

  B[0][0] = 0; B[0][1] =  5; B[0][2] = 2; B[0][3] = -2; B[0][4] = 0.1;
  B[1][0] = 6; B[1][1] = 7; B[1][2] =  3; B[1][3] = -21; B[1][4] = 0.5;
  B[2][0] = 4; B[2][1] = -2; B[2][2] =  -1; B[2][3] = 2.2; B[2][4] = 3.4;
  B[3][0] = 4; B[3][1] = -2; B[3][2] =  -1; B[3][3] = 2.2; B[3][4] = 3.4;
  B[4][0] = 6; B[4][1] = 7; B[4][2] =  3; B[4][3] = -21; B[4][4] = 0.5;

  b[0] = 1; b[1] =  2; b[2] = 3; b[3] = 4; b[4] = 5; 

  b = linear_system_solver_singular(5, b, B);
